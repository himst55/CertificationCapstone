...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df.groupby(['class', 'Booster Version Category'])['Payload Mass (kg)'].sum().reset_index(name="Total Payload")
        print(filtered_df)
        fig = px.scatter(filtered_df, x='Total Payload', 
        y='class', color='Booster Version Category',
        title='All Sites')
        return fig
# Run the app
